...
# ==============================
# Selecting molecules to run that pass thresholds
# ==============================
...
for k, v in potential_molecules.items():
    ...
    if (EG_D_A <= set_EG_value) or (EG_A_D <= set_EG_value):
        ...
        if len(all_data[all_data['SMILES'] == canon_smi]) > 0:
            ...
            #Run Psi4 calculations; planarity and energy gap if the data is not in archieve or not been ran before
            ran_molecules[k] = v
